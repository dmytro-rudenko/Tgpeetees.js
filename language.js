...
exports.default = {
  ...
  Other text messages will be processed and responded to by the AI.`,
        ...
        sorry: "Sorry, I can't keep up the conversation. Press the 'Share feelings' button with me.",
  ...
  Інші текстові повідомлення будуть оброблені та отримають відповідь від ІІ.`,
        ...
        sorry: "Вибачте, я не можу продовжити розмову. Натисніть кнопку 'Поділитися почуттями' зі мною.",
        limit: "Досягнуто ліміт розмови. Будь ласка, спробуйте пізніше.",
        pleaseWait: "Будь ласка, зачекайте...",
        youCanShare: "Ви можете поділитися своїми почуттями зі мною на рідній мові.",
